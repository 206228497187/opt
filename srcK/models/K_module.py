...
class KLitModule(LightningModule):
...
if __name__ == "__main__":
    ...
    # from src_pf.models.components.resnet18 import Backbone
    # from src_pf.models.components.mobilenetv2 import MobileNetV2
    from srcK.models.components.shufflenetv2 import ShuffleNetV2
    b = ShuffleNetV2()
    a = KLitModule(b,None,None)
